#include "ros/ros.h"
#include "beginner_tutorials/Oint_Control.h"
#include <math.h>
...
bool interpolate(beginner_tutorials::Oint_Control::Request &req, beginner_tutorials::Oint_Control::Response &res) {
	pos[0]=req.x;
	pos[1]=req.y;
	pos[2]=req.z;
	angle[0]=req.roll;
...
int main(int argc, char **argv) {
	...
	ros::NodeHandle n;
	ros::ServiceServer service=n.advertiseService("Oint_Control", interpolate);
	...
	ROS_INFO("Gotowy do interpolacji");
