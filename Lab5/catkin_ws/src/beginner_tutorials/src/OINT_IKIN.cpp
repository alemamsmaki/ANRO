...
bool set_trajectory(beginner_tutorials::oint_trajectory::Request &req, beginner_tutorials::oint_trajectory::Response &res) {
...
bool interpolate(beginner_tutorials::oint_point::Request &req, beginner_tutorials::oint_point::Response &res) {
